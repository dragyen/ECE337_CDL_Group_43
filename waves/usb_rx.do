...
add wave -noupdate -expand -group {DUT Internal} -group Next_ /tb_usb_rx/DUT/next_count
add wave -noupdate -expand -group {DUT Internal} -group Next_ /tb_usb_rx/DUT/next_state
add wave -noupdate -expand -group {DUT Internal} -group Next_ /tb_usb_rx/DUT/next_pid
add wave -noupdate -expand -group {DUT Internal} -group Next_ /tb_usb_rx/DUT/next_byte_done
add wave -noupdate -expand -group {DUT Internal} -group Next_ /tb_usb_rx/DUT/next_token_done
...
add wave -noupdate -expand -group {DUT Internal} -color Cyan /tb_usb_rx/clk
add wave -noupdate -expand -group {DUT Internal} -color {Cornflower Blue} /tb_usb_rx/DUT/valid_bit
add wave -noupdate -expand -group {DUT Internal} -color Orange /tb_usb_rx/DUT/nrzi1/new_bit
add wave -noupdate -expand -group {DUT Internal} -color Pink /tb_usb_rx/DUT/decoded_data
add wave -noupdate -expand -group {DUT Internal} -color Gold /tb_usb_rx/DUT/shift_strobe
add wave -noupdate -expand -group {DUT Internal} -color Magenta /tb_usb_rx/DUT/count
